...
export function Dashboard() {
  ...
  function getLastTransactionDate(
    ...
    //return dayjs(lastTransaction).format("DD/MM/YY");
  }
  ...
  async function loadTransactions() {
    ...
    setHighlightData({
      entries: {
        ...
        lastTransaction: `Útima entrada dia ${lastTransactionEntries}`,
      },
      expensives: {
        ...
        lastTransaction: `Útima entrada dia ${lastTransactionExpensive}`,
      },
      total: {
